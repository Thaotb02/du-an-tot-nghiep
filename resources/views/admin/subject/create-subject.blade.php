               ...
               <div class="col-sm-8">
                  <div class="card">
                     <div class="card-header">
                        <h3 style="font-weight: 600">Thêm mới bộ môn</h3>
                     </div>
                     <div class="card-block">
                        <form id="main" method="post"action="{{route('subject.add')}}" enctype="multipart/form-data">
                           @csrf
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="subject_name" id="name" value="{{old('subject_name')}}"/>
                                                 @error('subject_name')
                                                <span class="messages" style="color:red">{{$message}}</span>
                                                 @enderror
                              </div>
                              ...
                              <div class="form-group">
                                   ...
                                   <textarea type="text" class="form-control" name="description" id="description" rows="13">{{old('description')}}</textarea>
                               @error('description')
                               <span class="messages" style="color:red">{{$message}}</span>
                               @enderror
                                </div>
                              ...
                              <div class="col-sm-6">
                                <div class="upload">
                                    <div class="form">
                                        ...
                                        <span>
                                            <img src="{{ asset('').'upload/default-avatar.png' }}"
